...
export default function SignupDialog(props) {
    ...
    const signupDetailDialog = () => {
        return (<div>
            ...
            >   
                ...
                <img  src={`${ServerURL}/images/popimg.webp`} style={{width:'100%',height:'100%'}}/></div>
                ...
                <DialogContent dividers={scroll === 'paper'}>
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs={12}>
                            ...
                            <TextField fullWidth placeholder='dd/mm/yyyy' id="standard-basic" variant="standard" />
                        </Grid>
                        ...
                        <Grid item xs={12}>
                            ...
                            <TextField fullWidth placeholder='name@email.com' id="standard-basic" variant="standard" />
                        </Grid>
                        <Grid item xs={12}>
                            <div>
                                <FormControlLabel
                    ...
                    <Grid container spacing={3}>
                        <Grid item xs={12}>
                            <div style={{ padding: 14 }}>
                                <Button style={{ background: 'gray', color: '#000' }} fullWidth variant="contained">SUBMIT</Button>
                            </div>
                        </Grid>
                    </Grid>
                </DialogActions>
    ...
    return (<div>
        <div style={{ fontFamily: 'Sans-serif', fontSize: 13, fontWeight: 600 }}>
            <div onClick={handleClickOpen}> LOGIN | SINUP</div>
        </div>
